namespace CC_SchoolProject_ASP.Services
{
    public class UserHelper
    {
        ...
        public static bool IsValidatedTeacher(string? userToken, string? userTokenExpiration, string? userRole)
        {
            bool validToken = IsTokenValid(userToken, userTokenExpiration);
            ...
            {
                validTrader = (userRole == "Teacher" && validToken);
            }
        ...
        public static bool IsValidatedPrincipal(string? userToken, string? userTokenExpiration, string? userRole)
        {
            bool validToken = IsTokenValid(userToken, userTokenExpiration);
            bool validTrader = false;
            ...
            {
                validTrader = (userRole == "Principal" && validToken);
            }
